    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAuthentication("Bearer")
                .AddIdentityServerAuthentication(options =>
                {
                    ...
                    options.ApiSecret = "apidois";
                    options.ApiName = "resourceApiDois";
                });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                {
                    options.SwaggerEndpoint("/swagger/v1/swagger.json", "ProjetoDois.API v1");

                    options.OAuthClientId("projeto.api.dois");
                    options.OAuthClientSecret("mvc1");
                    options.OAuthAppName("Swagger API Teste Dois UI");
